...
const ActivityDropDownBox = ({
  ...
  return (
    <div className="flex flex-col relative">
      <label className="absolute top-[-9px] px-1 bg-white left-5  text-[#121121] ">
        체험명
      </label>
      <input
        type="text"
        className="border border-black pl-4 py-5 pr-10 rounded outline-none whitespace-normal overflow-hidden text-ellipsis"
